...
private func sysctlString(_ key: String) -> String? { nil }
private func sysctlUInt64(_ key: String) -> UInt64? { nil }
private func sysctlInt(_ key: String) -> Int32? { nil }

enum DeviceMemoryBridge { static func availableRAM() -> Int64 { 0 } }
